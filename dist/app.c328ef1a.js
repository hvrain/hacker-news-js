...
function paintNewsFeed() {
  ...
  for (var i = (store.currentPage - 1) * 10; i < store.currentPage * 10; i++) {
    newsList.push("\n      <div class=\"p-6 ".concat(newsFeed[i].read ? 'bg-red-300' : 'bg-white', " mt-6 rounded-lg shadow-md transition-colors duration-500 hover:bg-green-100\">\n        <div class=\"flex\">\n          <div class=\"flex-auto\">\n            <a href=\"#/show/").concat(newsFeed[i].id, "\">").concat(newsFeed[i].title, "</a>\n          </div>\n          <div class=\"text-center text-sm\">\n            <div class=\"w-10 text-white bg-green-300 rounded-lg px-0 py-2\">").concat(newsFeed[i].comments_count, "</div>\n          </div>\n        </div>\n        <div class=\"flex mt-3\">\n          <div class=\"grid grid-cols-3 text-sm text-gray-500\">\n            <div><i class=\"fa-solid fa-user mr-1\"></i>").concat(newsFeed[i].user, "</div>\n            <div><i class=\"fa-solid fa-heart pr-1\"></i>").concat(newsFeed[i].points, "</div>\n            <div><i class=\"fa-regular fa-clock pr-1\"></i>").concat(newsFeed[i].time_ago, "</div>\n          </div>\n        </div>\n      </div>\n    "));
  }
...
function paintNewsDetail() {
  ...
  var newsContent = getHnApi(CONTENT_URL.replace('@id', id));
...
},{}],"../../../../Users/kim49/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "6533" + '/');
...
},{}]},{},["../../../../Users/kim49/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.js"], null)
